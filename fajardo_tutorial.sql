...
-- Started on 2019-12-17 16:24:02
...
--
-- TOC entry 196 (class 1259 OID 1830086)
-- Name: schedule; Type: TABLE; Schema: public; Owner: izsbpyzgtcspjh
--
...
ALTER TABLE public.schedule OWNER TO izsbpyzgtcspjh;

--
-- TOC entry 3820 (class 0 OID 1830086)
-- Dependencies: 196
-- Data for Name: schedule; Type: TABLE DATA; Schema: public; Owner: izsbpyzgtcspjh
--

COPY public.schedule (staffno, tutorname, tuteeno, tuteename, appointment_date, appointment_time, tutorialno) FROM stdin;
...
-- Dependencies: 3
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: izsbpyzgtcspjh
--

REVOKE ALL ON SCHEMA public FROM postgres;
REVOKE ALL ON SCHEMA public FROM PUBLIC;
GRANT ALL ON SCHEMA public TO izsbpyzgtcspjh;
...
GRANT ALL ON LANGUAGE plpgsql TO izsbpyzgtcspjh;


-- Completed on 2019-12-17 16:24:22
